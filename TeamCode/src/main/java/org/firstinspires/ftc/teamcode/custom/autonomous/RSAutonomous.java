...
@Autonomous(name = "right side autonomous 4")
public class RSAutonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence preload = drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToConstantHeading(new Vector2d(-1.5, -26))
                .waitSeconds(0.3)
                ...
                .UNSTABLE_addTemporalMarkerOffset(0, () -> setTower(0.78))
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.6, () -> setClaw(true))
                .UNSTABLE_addTemporalMarkerOffset(1.6, () -> setLift(1))
                .UNSTABLE_addTemporalMarkerOffset(1.7, () -> setLift(0))
...
//                .build();
        ...
        TrajectorySequence stackToJunction = drive.trajectorySequenceBuilder(new Pose2d(-12, -66.5, 0))
                ...
                .splineTo(new Vector2d(-1, -23), Math.toRadians(-315))
                //deposit cone
                .waitSeconds(0.3)
                .UNSTABLE_addTemporalMarkerOffset(0.1, () -> setLift(-0.7))
                .UNSTABLE_addTemporalMarkerOffset(0.3, () -> setLift(0))
...
//                            .UNSTABLE_addTemporalMarkerOffset(1.3, () -> setTower(0))//doesnt work???
                .splineToSplineHeading(new Pose2d(-12, -36, Math.toRadians(0)), Math.toRadians(-90))
                            .UNSTABLE_addTemporalMarkerOffset(0.1, () -> setTower(-1))
                            .UNSTABLE_addTemporalMarkerOffset(0.45, () -> setTower(0))
...
//
        ...
        Pose2d endPose = new Pose2d(new Vector2d(-13, -44), Math.toRadians(315));

        TrajectorySequence leftParking = drive.trajectorySequenceBuilder(endPose)
                .lineTo(new Vector2d(-13, -12))
                .build();

        TrajectorySequence midParking = drive.trajectorySequenceBuilder(endPose)
                .lineTo(new Vector2d(-13, -44.1))
                .build();

        TrajectorySequence rightParking = drive.trajectorySequenceBuilder(endPose)
